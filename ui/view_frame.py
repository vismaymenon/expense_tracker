...
ALT_ROW_COLOR = "#242424"  # Default CTk dark background
BG_COLOR = "#2B2B2B"
TEXT_COLOR = "#DCE4EE"
INCOME_COLOR = "#00A968"
...
class ViewFrame(ctk.CTkTabview):
    ...
    def populate_all_tabs(self):
        ...
        scroll_frame = tab_frame.winfo_children()[0].winfo_children()[0].winfo_children()[0] # Assumes scroll frame is the only child
